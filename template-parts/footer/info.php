...
<?php } endif; ?>
		...
		<img src="<?php echo get_theme_mod( 'footer_url_setting', '' ); ?>" <?php  if( get_theme_mod( 'footer-image-width') != null ):  { ?> style="height:<?php echo get_theme_mod( 'footer-image-width', '' );?>vw;"<?php } endif; ?>>
	</div>
